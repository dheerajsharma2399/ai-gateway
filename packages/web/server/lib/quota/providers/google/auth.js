...
const ANTIGRAVITY_GOOGLE_CLIENT_ID =
  process.env.ANTIGRAVITY_GOOGLE_CLIENT_ID ?? 'your-antigravity-google-client-id';
const ANTIGRAVITY_GOOGLE_CLIENT_SECRET =
  process.env.ANTIGRAVITY_GOOGLE_CLIENT_SECRET ?? 'your-antigravity-google-client-secret';
const GEMINI_GOOGLE_CLIENT_ID =
  process.env.GEMINI_GOOGLE_CLIENT_ID ?? 'your-gemini-google-client-id';
const GEMINI_GOOGLE_CLIENT_SECRET =
  process.env.GEMINI_GOOGLE_CLIENT_SECRET ?? 'your-gemini-google-client-secret';
